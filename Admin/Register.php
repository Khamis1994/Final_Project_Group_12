                    ...
                    <div class="login-content"  style="background-color: #365b6d; color: #f7f7f7;" >
						...
						<div class="login-form"  style="background-color: #365b6d; color: #f7f7f7;" >
							<form action="" method="POST" class="login-email">
            					...
            					<button class="au-btn au-btn--block  m-b-20" type="submit" name="submit"  style="background-color: #41c1ba; color: #365b6d;" >Login</button>
								
								<p class="login-register-text">Have an account? <a href="login_user.php">Login Here</a>.</p>
								<p class="login-register-text">Back to <a href="index.php">Home Page</a>.</p>
